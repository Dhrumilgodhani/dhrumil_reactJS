...
const Lacture2 = () => {
  ...
  return (
    <>
      <div>
        <h1 className="text-center text-black p-6 bg-purple-500 text-3xl">
        ...
        <div className="flex justify-center mt-10">
          ...
          <input
            type="text"
            className="px-6 py-2 bg-slate-300 rounded-md focus:outline-none"
        ...
        <div className="flex justify-center items-center gap-2 flex-wrap mt-20 px-4">
          {ProductList.map((val) => {
            return (
              <>
                <div className="size-[430px] border-2 border-solid border-black pl-2 mb-4 ">
                  <div className="flex justify-center items-center">
                    <img
                      className="size-72 transition-all ease-linear duration-300"
                      src={val.images}
                    />
                  </div>
